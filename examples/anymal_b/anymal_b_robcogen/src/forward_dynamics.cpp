...
const pronto::anymal::dyn::ForwardDynamics::ExtForces
    pronto::anymal::dyn::ForwardDynamics::zeroExtForces(Force::Zero());

pronto::anymal::dyn::ForwardDynamics::ForwardDynamics(InertiaProperties& inertia, MotionTransforms& transforms) :
...
void pronto::anymal::dyn::ForwardDynamics::fd(
    JointState& qdd,
    Acceleration& base_a,
