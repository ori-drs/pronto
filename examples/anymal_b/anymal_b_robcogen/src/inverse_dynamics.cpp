...
using namespace pronto::anymal::dyn;

// Initialization of static-const data
const pronto::anymal::dyn::InverseDynamics::ExtForces
pronto::anymal::dyn::InverseDynamics::zeroExtForces(Force::Zero());

pronto::anymal::dyn::InverseDynamics::InverseDynamics(InertiaProperties& inertia, MotionTransforms& transforms) :
...
void pronto::anymal::dyn::InverseDynamics::id(
...
void pronto::anymal::dyn::InverseDynamics::G_terms_fully_actuated(
...
void pronto::anymal::dyn::InverseDynamics::C_terms_fully_actuated(
    Force& baseWrench, JointState& jForces,
...
void pronto::anymal::dyn::InverseDynamics::id_fully_actuated(
        Force& baseWrench, JointState& jForces,
...
void pronto::anymal::dyn::InverseDynamics::secondPass_fullyActuated(JointState& jForces)
{
    // Link 'RH_SHANK'
